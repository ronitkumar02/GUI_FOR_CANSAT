...
class UI(QMainWindow) :
    ...
    def PlotOnCanvas(self):
        ...
        def animate(i):
            ...
            self.ax.cla()
            self.ax.plot(x  ,y1  ,"r"  ,label="one")
            self.ax.set(xlabel='x-axis'  , ylabel='Pressure')
            # self.ax.legend(loc="upper left")
            y2 = data.tail(20)['total_2']
            self.ax1.cla()
            self.ax1.plot(x  ,y2  ,label="two")
            self.ax1.set(xlabel='x-axis'  , ylabel='Analog Temparature')
            # self.ax1.legend(loc="upper left")
            y3=data.tail(20)["total_2"]
            self.ax2.cla()
            self.ax2.plot(x  ,y3  ,label="two")
            self.ax2.set(xlabel='x-axis'  , ylabel='Humidity')
            y4=data.tail(20)["total_2"]
            self.ax3.cla()
            self.ax3.plot(x  ,y4  ,label="two")
            self.ax3.set(xlabel='x-axis'  , ylabel='Temperature')
            self.ax4.cla()
            self.ax4.plot(x  ,y2  ,label="two")
